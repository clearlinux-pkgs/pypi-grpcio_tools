...
Version  : 1.48.1
Release  : 28
URL      : https://files.pythonhosted.org/packages/77/9f/ed2a697725c762a136c81bb92e21c86787492b716493e9e8e4ee192369cf/grpcio-tools-1.48.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/77/9f/ed2a697725c762a136c81bb92e21c86787492b716493e9e8e4ee192369cf/grpcio-tools-1.48.1.tar.gz
...
%prep
%setup -q -n grpcio-tools-1.48.1
cd %{_builddir}/grpcio-tools-1.48.1
pushd ..
cp -a grpcio-tools-1.48.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662135842
