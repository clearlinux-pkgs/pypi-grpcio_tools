...
Version  : 1.62.1
Release  : 57
URL      : https://files.pythonhosted.org/packages/60/d5/76bd9891050a34a4fb8b47887fa6b2f75f0e99f4e9138becfb0421bb7175/grpcio-tools-1.62.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/60/d5/76bd9891050a34a4fb8b47887fa6b2f75f0e99f4e9138becfb0421bb7175/grpcio-tools-1.62.1.tar.gz
...
%prep
%setup -q -n grpcio-tools-1.62.1
cd %{_builddir}/grpcio-tools-1.62.1
pushd ..
cp -a grpcio-tools-1.62.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710172347
