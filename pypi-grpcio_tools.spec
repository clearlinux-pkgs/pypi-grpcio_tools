...
Version  : 1.60.1
Release  : 55
URL      : https://files.pythonhosted.org/packages/2c/7f/30d9ef28cbe302c622bf289d194689cd571ea4df0b492d46b95e503aabb1/grpcio-tools-1.60.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/2c/7f/30d9ef28cbe302c622bf289d194689cd571ea4df0b492d46b95e503aabb1/grpcio-tools-1.60.1.tar.gz
...
%prep
%setup -q -n grpcio-tools-1.60.1
cd %{_builddir}/grpcio-tools-1.60.1
pushd ..
cp -a grpcio-tools-1.60.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706825814
