...
Source0  : https://files.pythonhosted.org/packages/c1/fe/3adf1035c1f9e9243516530beae67e197f2acc17562ec75f03a0ba77fc55/grpcio_tools-1.70.0.tar.gz
...
%prep
%setup -q -n grpcio_tools-1.70.0
cd %{_builddir}/grpcio_tools-1.70.0
pushd ..
cp -a grpcio_tools-1.70.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737753200
