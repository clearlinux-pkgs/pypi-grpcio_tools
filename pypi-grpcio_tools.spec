...
Source0  : https://files.pythonhosted.org/packages/62/02/612ee1b34da2158fcb2ad35a115606bf552856e0d7c82fe2b479cb70d7a7/grpcio-tools-1.50.0.tar.gz
...
%prep
%setup -q -n grpcio-tools-1.50.0
cd %{_builddir}/grpcio-tools-1.50.0
pushd ..
cp -a grpcio-tools-1.50.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666135657
